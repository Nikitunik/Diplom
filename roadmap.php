	...
	<div class="banner-con-container darkmode-header">
		...
		<div class='banner-con-title fade-up-onstart'>
			...
			<div class='banner-tx2-title fade-up-onstart'>
				<p>
					Цели, которые были поставлены перед Нами
				</p>
			</div>
		</div>
	</div>
	<div class ="handheld-img-overlay"></div>
	<div class="page-con-container">
			<div class="page-in-container">
			<div class="markdown darkmode-block">
				 <h2>Цель 1</h2>
                    <p>Описание вашей первой цели.</p>
                    
                    <h2>Цель 2</h2>
                    <p>Описание вашей второй цели.</p>
                    
                    <h2>Цель 3</h2>
                    <p>Описание вашей третьей цели.</p>
			</div>
		</div>
	</div>
</div>
